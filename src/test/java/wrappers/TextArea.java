...
public class TextArea {
    ...
    private static final String TEXT_AREA_XPATH = "//label[text()='%s']/following-sibling::div//div[@class='toastui-editor-ww-container']//p[contains(@data-placeholder,'For example' )]";

    public void write(String label, String text) {
        log.info("Write '{}' into '{}' input field", text, label);
        if (text != null) {
            $(By.xpath(String.format(TEXT_AREA_XPATH, label))).sendKeys(text);
        }
    }
}
